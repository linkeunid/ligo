...
// NewChild creates a child container that inherits providers from this di.
...
// Types returns all registered types in the di.
...
// Register adds a provider to the di.
